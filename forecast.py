...
owm = pyowm.OWM('f404a832a4316a7a0403fbe37b23e129')
...
def draw_bar_chart():
    ...
    st.plotly_chart(fig)
    st.title("Minimum and Maximum Temperatures For Next 5 Days")
    for i in range(0, 5):
...
st.write("### Made by Students of LNCTS")
st.text("Anmol Saxena")
st.text("Ajeyata Verma")
st.text("Tejas Dwivedi")
st.text("Vivek Singh")
